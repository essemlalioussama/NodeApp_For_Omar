...
class ExpressionProcessor {
  ...
  process(input, context = {}) {
    ...
    return expression ? expression(_objectSpread2({}, context, {
      expression: input
    })) : null;
  }
  ...
  process(element, context) {
    ...
    while (element.firstChild) {
      ...
      if (child instanceof Element && element.__thymeleafLocalVariables) {
        child.__thymeleafLocalVariables = _objectSpread2({}, child.__thymeleafLocalVariables || {}, {}, element.__thymeleafLocalVariables);
      }
    }
...
function deserialize(htmlString) {
  return   /* istanbul ignore next */  require('@ultraq/dom-utils').deserialize(htmlString) ;
}
/**
...
function serialize(documentFragment) {
  return   /* istanbul ignore next */  require('@ultraq/dom-utils').serialize(documentFragment) ;
}
...
const STANDARD_CONFIGURATION = _objectSpread2({}, DEFAULT_CONFIGURATION, {
...
class TemplateEngine {
  ...
  constructor({
    ...
    this.expressionObjects = dialects.reduce((acc, {
      expressionObjects
    }) => expressionObjects ? _objectSpread2({}, acc, {}, expressionObjects) : acc, {});
  }
  /**
  ...
  process(template, context = {}) {
    ...
    return this.processNode(rootElement, _objectSpread2({}, context, {}, this.expressionObjects, {
  ...
  async processNode(element, context = {}) {
    ...
    let localContext = _objectSpread2({}, context, {}, localVariables);
...
export { AttributeProcessor, Dialect, ExpressionProcessor, STANDARD_CONFIGURATION, StandardDialect, TemplateEngine };
